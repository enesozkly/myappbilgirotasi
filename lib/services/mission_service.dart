...
class MissionService {
  ...
  // ══════════════════════════════════════════════════════════════════════
  // GÜNLÜK GÖREV HAVUZU
  // Sabit liste: yapay/rasgele görev yok. Toplam bonus enerji limiti korundu.
  // ══════════════════════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════════════════════
  // HAFTALIK GÖREVLER
  // Enerji ödülleri 10-15 arası ayarlandı. Sadece haftalık olarak
  // sıfırlanan sayaçlar (weeklyQuestions, weeklyCorrect, weeklySections, weeklyAds) kullanıldı.
  // ══════════════════════════════════════════════════════════════════════
  static const List<Map<String, dynamic>> _weeklyMissions = [
    {
      'id': 'weekly_questions_150',
      'title': '150 Soru Çöz',
      'description': 'Bu hafta toplam 150 soru çözerek pratik yap',
      'icon': '📝',
      'targetCount': 150,
      'bonusEnergyReward': 15,
      'xpReward': 250,
      'trackField': 'weeklyQuestions',
      'type': 'weekly',
    },
    {
      'id': 'weekly_correct_100',
      'title': '100 Doğru Cevap',
      'description': 'Bu hafta toplamda 100 soruyu doğru bil',
      'icon': '🎯',
      'targetCount': 100,
      'bonusEnergyReward': 15,
      'xpReward': 200,
    ...
    },
    {
      'id': 'weekly_ads_5',
      'title': '5 Reklam İzle',
      'description': 'Hafta içinde 5 ödüllü reklam izleyerek ekstra destek kazan',
      'icon': '📺',
      'targetCount': 5,
  ...
  static const int weeklyAllCompletedBonus = 20;
  static const int weeklyAllCompletedXp = 300;
  ...
  Future<void> _checkWeeklyAllBonus(String uid) async {
    ...
    try {
      ...
      if (allClaimed) {
        await _energy.addBonusEnergyUnlimited(uid, weeklyAllCompletedBonus);
