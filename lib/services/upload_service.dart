...
class QuestionUploader {
  ...
  static const List<Map<String, String>> _dosyaListesi = [
    ...
    {'file': 'assets/ayt_sayisal_matematik/limit.json', 'ders': 'Matematik', 'konu': 'Limit', 'exam': 'AYT Sayısal', 'tip': 'json'},
    ...
    {'file': 'assets/ayt_esitagirlik_matematik/limit.json', 'ders': 'Matematik', 'konu': 'Limit', 'exam': 'AYT Eşit Ağırlık', 'tip': 'json'},
    ...
    // YDS İNGİLİZCE / ALMANCA ve ALES MATEMATİK / GEOMETRİ
    {'file': 'assets/yds_ingilizce/kelime_ve_phrasal_verbs.json', 'ders': 'İngilizce', 'konu': 'Kelime ve Phrasal Verbs', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/dil_bilgisi.json', 'ders': 'İngilizce', 'konu': 'Dil Bilgisi', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/cloze_test.json', 'ders': 'İngilizce', 'konu': 'Cloze Test', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/cumle_tamamlama.json', 'ders': 'İngilizce', 'konu': 'Cümle Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/ceviri_sorulari.json', 'ders': 'İngilizce', 'konu': 'Çeviri Soruları', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/diyalog_tamamlama.json', 'ders': 'İngilizce', 'konu': 'Diyalog Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/paragraf_sorulari.json', 'ders': 'İngilizce', 'konu': 'Paragraf Soruları', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/yakin_anlamli_cumle.json', 'ders': 'İngilizce', 'konu': 'Yakın Anlamlı Cümle', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/paragraf_tamamlama.json', 'ders': 'İngilizce', 'konu': 'Paragraf Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_ingilizce/anlatim_butunlugunu_bozan_cumle.json', 'ders': 'İngilizce', 'konu': 'Anlatım Bütünlüğünü Bozan Cümle', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/kelime_ve_fiiller.json', 'ders': 'Almanca', 'konu': 'Kelime ve Fiiller', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/dil_bilgisi.json', 'ders': 'Almanca', 'konu': 'Dil Bilgisi', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/cloze_test.json', 'ders': 'Almanca', 'konu': 'Cloze Test', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/cumle_tamamlama.json', 'ders': 'Almanca', 'konu': 'Cümle Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/ceviri_sorulari.json', 'ders': 'Almanca', 'konu': 'Çeviri Soruları', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/diyalog_tamamlama.json', 'ders': 'Almanca', 'konu': 'Diyalog Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/paragraf_sorulari.json', 'ders': 'Almanca', 'konu': 'Paragraf Soruları', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/yakin_anlamli_cumle.json', 'ders': 'Almanca', 'konu': 'Yakın Anlamlı Cümle', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/paragraf_tamamlama.json', 'ders': 'Almanca', 'konu': 'Paragraf Tamamlama', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/yds_almanca/anlatim_butunlugunu_bozan_cumle.json', 'ders': 'Almanca', 'konu': 'Anlatım Bütünlüğünü Bozan Cümle', 'exam': 'YDS', 'tip': 'json'},
    {'file': 'assets/ales_matematik/islem.json', 'ders': 'Matematik', 'konu': 'İşlem', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/rasyonel_sayilar.json', 'ders': 'Matematik', 'konu': 'Rasyonel Sayılar', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/bolunebilme_kurallari.json', 'ders': 'Matematik', 'konu': 'Bölünebilme Kuralları', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/uslu_sayilar_2.json', 'ders': 'Matematik', 'konu': 'Üslü Sayılar', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/koklu_sayilar.json', 'ders': 'Matematik', 'konu': 'Köklü Sayılar', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/mutlak_deger.json', 'ders': 'Matematik', 'konu': 'Mutlak Değer', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/esitsizlik.json', 'ders': 'Matematik', 'konu': 'Eşitsizlikler', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/ozdeslikler_carpanlara_ayirma.json', 'ders': 'Matematik', 'konu': 'Özdeşlikler ve Çarpanlara Ayırma', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/kumeler.json', 'ders': 'Matematik', 'konu': 'Kümeler', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/oran_oranti.json', 'ders': 'Matematik', 'konu': 'Oran ve Orantı', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/sayi_kesir_problemleri.json', 'ders': 'Matematik', 'konu': 'Sayı ve Kesir Problemleri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/yas_problemleri.json', 'ders': 'Matematik', 'konu': 'Yaş Problemleri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/isci_havuz_problemleri.json', 'ders': 'Matematik', 'konu': 'İşçi ve Havuz Problemleri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/hareket_problemleri.json', 'ders': 'Matematik', 'konu': 'Hareket Problemleri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/karisim_problemleri.json', 'ders': 'Matematik', 'konu': 'Karışım Problemleri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/yuzde_kar_zarar_faiz.json', 'ders': 'Matematik', 'konu': 'Yüzde, Kâr-Zarar ve Faiz', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/saymanin_temel_ilkesi_olasilik.json', 'ders': 'Matematik', 'konu': 'Saymanın Temel İlkesi ve Olasılık', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_matematik/sayisal_mantik.json', 'ders': 'Matematik', 'konu': 'Sayısal Mantık', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/dogruda_acilar.json', 'ders': 'Geometri', 'konu': 'Doğruda Açılar', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/ucgende_acilar.json', 'ders': 'Geometri', 'konu': 'Üçgende Açılar', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/ucgende_uzunluk_ve_alan.json', 'ders': 'Geometri', 'konu': 'Üçgende Uzunluk ve Alan', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/ucgende_acortay_kenarortay_benzerlik.json', 'ders': 'Geometri', 'konu': 'Üçgende Açıortay, Kenarortay ve Benzerlik', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/dortgenler.json', 'ders': 'Geometri', 'konu': 'Dörtgenler', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/cember_ve_daire.json', 'ders': 'Geometri', 'konu': 'Çember ve Daire', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/analitik_geometri.json', 'ders': 'Geometri', 'konu': 'Analitik Geometri', 'exam': 'ALES', 'tip': 'json'},
    {'file': 'assets/ales_geometri/kati_cisimler.json', 'ders': 'Geometri', 'konu': 'Katı Cisimler', 'exam': 'ALES', 'tip': 'json'},
  ];
